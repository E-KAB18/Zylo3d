...
const productsData: Product[] = [
  {
    ...
    indications: [
      { name: "Diagnostic Model", minutes: "45", clicks: "3" },
      { name: "Single Unit Crown", minutes: "55", clicks: "4" },
      { name: "Denture Base", minutes: "90", clicks: "5" },
      { name: "Dental Splint", minutes: "40", clicks: "3" },
      { name: "Sports Guard", minutes: "35", clicks: "3" },
      { name: "Surgical Guide", minutes: "50", clicks: "4" },
    ],
    specs: [
